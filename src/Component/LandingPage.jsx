...
<div className="textstructure mt-40 px-6 md:px-20 space-y-6">
  <div className="master">
    <h1 className="uppercase text-4xl md:text-6xl lg:text-8xl font-[founders_Grotesk] font-semibold text-white ">
      we create
    </h1>
  </div>
  ...
  <div className="master relative flex items-center">
    ...
    className="uppercase text-4xl md:text-6xl lg:text-8xl font-[founders_Grotesk] font-semibold text-white pl-[16vw] md:pl-[10vw] z-20 relative"
  >
    eye opening
  </motion.h1>
  </div>
